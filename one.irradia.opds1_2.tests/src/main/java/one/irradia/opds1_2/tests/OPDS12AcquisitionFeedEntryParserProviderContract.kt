...
abstract class OPDS12AcquisitionFeedEntryParserProviderContract {
  ...
  fun testEntryOK() {
    ...
    Assert.assertEquals("Author", entry.authors[0])
  ...
  @Test
  fun testEntryAcquisitionBadEverything0() {
    val parser =
      this.parsers.createParser(
        uri = URI.create("urn:test"),
        stream = this.resource("entry-acq-bad-everything.xml"))

    val result =
      parser.parse() as OPDS12ParseResult.OPDS12ParseSucceeded

    Assert.assertEquals(0, result.result.acquisitions.size)
  }
  ...
  class FailingExtensionParser : OPDS12AcquisitionFeedEntryExtensionParserType {
  ...
  class FailingExtensionParserProvider : OPDS12AcquisitionFeedEntryExtensionParserProviderType {
    override fun createParser(context: OPDS12AcquisitionFeedEntryExtensionParserContextType): OPDS12AcquisitionFeedEntryExtensionParserType {
