...
import one.irradia.opds1_2.nypl.OPDS12NYPLAcquisitionFeedEntryParsers
...
abstract class OPDS12AcquisitionFeedEntryNYPLParserProviderContract {
  ...
  fun testEntryOKAcquisitionsAvailability() {
    val parser =
      this.parsers.createParser(
        ...
        extensionParsers = listOf(OPDS12NYPLAcquisitionFeedEntryParsers()))
